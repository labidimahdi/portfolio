    ...
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          I am a software engineer and full-stack developer passionate about crafting innovative and high-performing applications. With a strong background in both web and software development, I tackle technical challenges with creativity and precision
          </p>
